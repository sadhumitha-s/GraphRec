...
from app.ml.graphsage_serving import recommend_graphsage_for_user
...
def get_recommendations(
    user_id: int,
    k: int = 5,
    algo: str = Query("bfs", description="Algorithm: 'bfs', 'ppr', or 'graphsage'"),
    ...
    # 3. STRATEGY A: THE GRAPH ENGINE (BFS / PPR / GraphSAGE)
